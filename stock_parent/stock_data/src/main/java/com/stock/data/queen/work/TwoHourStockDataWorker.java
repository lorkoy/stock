...
public class TwoHourStockDataWorker extends Worker<StockCode> {
	
	private static final Logger logger = LoggerFactory.getLogger(TwoHourStockDataWorker.class);
	
	public TwoHourStockDataWorker(BlockingQueue<StockCode> queen){
		super(queen);
	}

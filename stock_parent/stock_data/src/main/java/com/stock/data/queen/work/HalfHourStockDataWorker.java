...
public class HalfHourStockDataWorker extends Worker<StockCode> {
	
	private static final Logger logger = LoggerFactory.getLogger(HalfHourStockDataWorker.class);
	
	public HalfHourStockDataWorker(BlockingQueue<StockCode> queen){
		super(queen);
	}

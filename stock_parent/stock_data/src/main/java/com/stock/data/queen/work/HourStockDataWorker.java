...
public class HourStockDataWorker extends Worker<StockCode> {
	
	private static final Logger logger = LoggerFactory.getLogger(HourStockDataWorker.class);
	
	public HourStockDataWorker(BlockingQueue<StockCode> queen){
		super(queen);
	}

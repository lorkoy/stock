<!-- jQuery 2.1.4 -->
    ...
    <!-- AdminLTE App -->
    <script src="${pageContext.request. contextPath}/AdminLTE/js/app.min.js" type="text/javascript"></script>    
    
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="${pageContext.request. contextPath}/AdminLTE/js/pages/dashboard.js" type="text/javascript"></script>    
    
    <!-- AdminLTE for demo purposes -->
    <script src="${pageContext.request. contextPath}/AdminLTE/js/demo.js" type="text/javascript"></script>